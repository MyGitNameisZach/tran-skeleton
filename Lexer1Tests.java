...
public class Lexer1Tests {
    ...
    @Test
    public void ZachTestmedium(){
        var l = new Lexer("word1split8by9num");
        try{
            var res = l.Lex();
            Assertions.assertEquals(7, res.size());
            Assertions.assertEquals(Token.TokenTypes.WORD, res.get(0).getType());
            ...
            Assertions.assertEquals("split", res.get(2).getValue());
            ...
            Assertions.assertEquals("by", res.get(4).getValue());
            Assertions.assertEquals(Token.TokenTypes.NUMBER, res.get(5).getType());
            Assertions.assertEquals("9", res.get(5).getValue());
            Assertions.assertEquals(Token.TokenTypes.WORD, res.get(6).getType());
            Assertions.assertEquals("num", res.get(6).getValue());
